...
move_uploaded_file($_FILES["img1"]["tmp_name"],"Uploads/brands" .time() . '-'.$_FILES["img1"]["name"]);
  ...
  $sql = "INSERT INTO brands(Name,Image,Option) 
                   VALUES('$bname','$image','$option')";
...
if($lastInsertId)
{
header('Location: vehicle-brands.php?msg=success');
}
else 
{
  ...
  <div class="form">
          <form name="insert-form" id="contact-form"  method="POST">        
             <div class="inputfield">
                  ...
                  <input type="text" name="bname" class="input" required>
               </div>  
