...
<body>
  ...
  <div class="form">
				  <form name="insert-form" id="contact-form"  method="POST" enctype="multipart/form-data"> 
								...
								<?php 
								$id=intval($_GET['imgid']);
								$sql ="SELECT Image1 from vehicles where vehicle.id=:id";
								$query = $dbh -> prepare($sql);
								$query-> bindParam(':id', $id, PDO::PARAM_STR);
								$query->execute();
                        ...
                        <center>					 
	                      <img src="Uploads/vehicles/<?php echo htmlentities($result->Image1);?>" width="300" height="200" style="border:solid 1px #000" class="input">
