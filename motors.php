...
<head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
      <link href="assets/css/btn.css" rel="stylesheet" />    <link rel='icon' href='assets/favicon2.ico' rel="icon" type='image/x-icon'/ >
</head>
<body>
            ...
            <div id="page-inner">
	            ...
	            <div class="row">
                    <div class="col-lg-12 col-md-12">
						...
						<center>
<!--****************************TABLE VEHICLES******************************** -->		
                        <a href="add-new-car.php">					
						<button class="button" style="vertical-align:middle"><span>Add New Vehicle </span></button>
						</a>		 		
                        ...
                        <table class="table table-striped table-bordered table-hover" width="100%" id="table-id" >
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td align="center">								     
										 <a href="edit-car.php?id=<?php echo $result->id;?>">
										 <i class="fa fa-pencil-square-o"style="font-size:25px;color:blue;padding:5px;"></i></a> 
										 
										 <a href="delete-vehicle.php?del=<?php echo $result->id;?>"><i class="fa fa-times"style="font-size:25px;color:red;"></i></a>
								    </td>									
                                </tr>                               					
                            <?php }} ?></tbody>
                        </table>
