...
if($msg==success){
	...
	<div class="col-lg-12 ">
		<div class="alert alert-success">
			 <strong> Success </strong> Vehicle Brand succesfully Added
		</div>                      
	</div> 	
	';
}
	...
	<div class="col-lg-12 ">
		<div class="alert alert-success">
			 <strong> Success </strong> Vehicle Brand succesfully Delete...!
		</div>                      
	</div>   	
	';
}
...
?>	
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h5></h5>
						<center>
						<a href="add-new-brand.php">
				        <button class="button" style="vertical-align:middle"><span>Add New Brand </span></button>
						</a>
                        ...
                        <table class="table table-striped table-bordered table-hover" width="100%" id="table-id">
                            <thead>
								   <tr>
									 ...
									 <th align="center"><font color="red">Upload Image </font></th>									 
									 <th align="center"><font color="red">Update </font></th>
                            ...
                            <tbody>
									...
									<td><?php echo htmlentities($result->Option);?></td>
									
 									<td align="center">								     
										 <a href="upload-brand-image.php?imgid=<?php echo $result->id;?>">
										 <i class="fa fa-upload"style="font-size:25px;color:blue;padding:5px;"></i>
										 </a> 
									...
									<td align="center">
									      <a href="delete-brand.php?del=<?php echo $result->id;?>">
