        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                 ...
                 <a href="add-new-design.php">
                <button class="button" style="vertical-align:middle"><span>Add New Design </span></button>
				</a>			
                        ...
                        <table class="table table-striped table-bordered table-hover" width="100%" id="table-id">
                            <thead>
                                ...
                                <tr>
								   ...
								   <th align="center"><font color="red">Image<br> Edit / upload</font></th>			   
								   <th align="center"><font color="red">Delete</font></th>
                                </tr>
                            </thead>
                            <tbody>
							    <tr>
									<?php $sql = "SELECT * FROM design ORDER BY id DESC";
									$query = $dbh -> prepare($sql);
									$query->execute();
									$results=$query->fetchAll(PDO::FETCH_OBJ);
									$cnt=1;
								   ...
								   <td>
								   <img src="Uploads/disigns/<?php echo htmlentities($result->Image);?>" width="150" height="100">
								   </td>
								   
                                    <td align="center">								     
										 <a href="upload-design-image.php?imgid=<?php echo $result->id;?>"><i class="fa fa-upload"style="font-size:25px;color:blue;padding:5px;"></i></a> 
										 
								    </td>
									
									<td  align="center">
									      <a href="delete-design2.php?del=<?php echo $result->id;?>"><i class="fa fa-times"style="font-size:25px;color:red;"></i></a>
									</td>
                                </tr>						
                           <?php }} ?>
						   </tbody>
